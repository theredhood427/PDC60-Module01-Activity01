...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Bangsil_Module01_Activity01.Android.dll" comes first in this list. */
		"Bangsil_Module01_Activity01.Android.dll",
		"Bangsil_Module01_Activity01.dll",
		"FormsViewGroup.dll",
